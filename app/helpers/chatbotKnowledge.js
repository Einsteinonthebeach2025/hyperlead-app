export const chatbotKnowledge = [
  ...
  },
  {
    ...
    answer:
      "Custom Leads let Pro & Enterprise users search our entire lead database for specific companies or filters. You can request leads like 'VPs at Ford' or 'Design agencies in Berlin' and get instant results. With Custom Leads, you become your own data sniper — no waiting, just precision.",
  },
  {
    triggers: [
      "How do I get leads?",
  ...
  {
    triggers: [
      "Why go Pro or Enterprise?",
      "What's the difference between plans?",
      "What does Enterprise include?",
      "Is it worth upgrading?",
    ],
    answer:
      "Upgrading unlocks: More leads per month. Faster lead delivery. Custom On-Demand Lead Search. AI Campaigns & Automation tools. Access to support priority queue. Enterprise users get the best ROI — built for scale.",
  },
  {
    triggers: [
